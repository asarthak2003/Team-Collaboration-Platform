...
import { Layers, User, Mail, Lock, Shield, Loader2, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-slate-900/60 border border-slate-900 p-8 rounded-2xl shadow-2xl backdrop-blur-md">
        ...
        {/* Error Alert Box */}
        {error && (
          <div className="flex items-center space-x-2 bg-rose-950/40 border border-rose-900/50 p-4 rounded-xl text-rose-400 text-sm mb-6">
